# 4x-ui Custom Subscription Templates

4x-ui can render your users' subscription pages from your own custom HTML templates.

## How to use a Custom Template

1. Go to the 4x-ui panel settings.
2. Under **Settings → Subscription → Information**, locate the **Sub Theme Directory** field.
3. Provide the absolute path to the folder containing your template (e.g. `/etc/4x-ui/sub_templates/my-theme/`).
4. Save the settings.

> **Note:** 4x-ui does not ship any templates by default. Create your own template folder anywhere
