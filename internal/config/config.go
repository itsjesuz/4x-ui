// Package config provides configuration management utilities for the 4x-ui panel,
...
// GetName returns the name of the 4x-ui application.
func GetName() string {
...
func GetLogFolder() string {
	...
	if testing.Testing() {
		return filepath.Join(os.TempDir(), "4x-ui-test-log")
	}
	if runtime.GOOS == "windows" {
