// Package model defines the database models and data structures used by the 4x-ui panel.
package model
...
import (
	...
	"github.com/itsjesuz/4x-ui/internal/util/json_util"
...
// User represents a user account in the 4x-ui panel.
type User struct {
...
// Setting stores key-value configuration settings for the 4x-ui panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote 4x-ui panel registered with the central panel.
