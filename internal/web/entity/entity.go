// Package entity defines data structures and entities used by the web layer of the 4x-ui panel.
package entity
...
// AllSetting contains all configuration settings for the 4x-ui panel including web server, Telegram bot, and subscription settings.
