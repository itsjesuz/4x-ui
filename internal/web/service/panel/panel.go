...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/itsjesuz/4x-ui/main/update.sh"
...
// GetUpdateInfo checks GitHub for the latest 4x-ui release.
...
func downloadPanelUpdater() (string, error) {
	...
	file, err := os.CreateTemp("", "4x-ui-update-*.sh")
	if err != nil {
		return "", err
	}
	path := file.Name()
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/itsjesuz/4x-ui/releases/latest")
	if err != nil {
		return "", err
	}
	defer resp.Body.Close()
